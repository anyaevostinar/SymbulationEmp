...
public:
   ...
   * Output: None
   *
   * Purpose: Governs free-living sym movement. A sym can move into a parallel host if conditions are met or move randomly around the world if permitted by the config settings.
   */
   ...
   *
   * Output: The extracted symbiont.
   *
   * Purpose: Removes a symbiont from the world, does NOT delete it, and returns it.
   */
