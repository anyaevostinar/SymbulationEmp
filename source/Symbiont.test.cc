...
TEST_CASE("Symbiont Constructor") {
    ...
    int_val = -1;
    Symbiont s(random, world, int_val);

    int_val = 1;
    Symbiont s4(random, world, int_val);
...
TEST_CASE("SetIntVal, GetIntVal") {
    ...
    int_val = -1;
    Symbiont s2(random, world, int_val);
    ...
    int_val = -1;
    Symbiont s3(random, world, int_val);
...
TEST_CASE("mutate") {
    ...
    WHEN("Mutation rate is zero") {
        ...
        Symbiont s(random, world, int_val, points, h_res, h_trans, mutation_rate);
...
TEST_CASE("reproduce") {
    ...
    WHEN("Mutation rate is not zero") {
        ...
        Symbiont s2(random, world, int_val, points, h_res, h_trans, mutation_rate);
