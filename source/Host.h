 ...
 */
 ...
 bool IsHost() { return true; }
   ...
   * Output: None
   * 
   * Purpose: To distribute resources to a host and its symbions. In the event that the host has no symbionts, 
   ...
   * Output: None
   * 
   * Purpose: To process the host, meaning determing eligability for reproduction, checking for vertical
