...
EMP_BUILD_CONFIG(SymConfigBase,
    ...
    VALUE(PHAGE_INC_VAL, double, 0, "the compatibility of the prophage to it's placement within the bacterium's genome. From 0 to 1"),
    VALUE(HOST_INC_VAL, double, 0, "the compatibility of the bacterium for the phage's placement in its genome, From 0 to 1"),
