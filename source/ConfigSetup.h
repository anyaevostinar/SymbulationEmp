...
EMP_BUILD_CONFIG(SymConfigBase,
    ...
    VALUE(INCORPORATION_VAL, double, 0, "the compatibility of the prophage to it's placement within the bacterium's genome. From 0 to 1"),
    VALUE(GENOME_VAL, double, 0, "Value of the bacterium genome, From 0 to 1"),
    VALUE(MUTATE_GENOME, bool, 0, "Whether the bacterium genome mutates or not, 0 or 1"),
    VALUE(MUTATE_INCORPORATION, bool, 0, "whether the incorporation_val mutates. 0 or 1"),
