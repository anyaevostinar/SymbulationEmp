...
EMP_BUILD_CONFIG(SymConfigBase,
    ...
    VALUE(CHANCE_OF_INDUCTION, double, -1, "Chance of induction for starting lysogenic phage, -1 for random distribution"),
    ...
    VALUE(MUTATE_INDUCTION_CHANCE, int, 0, "Should the chance of Induction mutate? 0 for no, 1 for yes"),
