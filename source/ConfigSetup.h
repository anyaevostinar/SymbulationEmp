...
EMP_BUILD_CONFIG(SymConfigBase,
    ...
    VALUE(RANDOM_INJECTION, bool, 1, "Should organisms be randomly injected into the world or should they be consistently spaced out? (1 for randomly inject, 0 for spaced out)"),
