...
EMP_BUILD_CONFIG(SymConfigBase,
    ...
    VALUE(INCORPORATION_VAL, double, 0, "the compatibility of the prophage to it's placement within the host's genome. From 0 to 1"),
    VALUE(MUTATE_INCORPORATION, bool, 0, "whether the incorporation_success mutates. 0 or 1"),
