...
EMP_BUILD_CONFIG(SymConfigBase,
    ...
    VALUE(SYM_VERT_TRANS_RES, double, 50, "How many resources required for symbiont vertical transmission"),
    ...
    VALUE(DOMINANT_COUNT, size_t, 1, "Number of dominant hosts to select"),
    ...
    VALUE(THREAD_COUNT, size_t, 4, "Number of threads used to process organisms in parallel"),
