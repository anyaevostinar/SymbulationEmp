...
EMP_EXTEND_CONFIG(SymConfigSGP, SymConfigBase,
  ...
  VALUE(HOST_ONLY_FIRST_TASK_CREDIT, int, 0, "Should hosts only get credit for their first task? (0 for no, 1 for yes)"),
  VALUE(SYM_ONLY_FIRST_TASK_CREDIT, int, 0, "Should symbionts only get credit for their first task? (0 for no, 1 for yes)"),
