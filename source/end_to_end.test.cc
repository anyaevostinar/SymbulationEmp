...
TEST_CASE( "End To End" ) {
  ...
  Test("vert_trans_0.1_spa", 17, 100, 0.002, 5, 0.1, -2, -2, 100, 100, 1001, 1, 0, 1, 4, 2, 1000, 0.3, 100, 1, 1);
  Test("vert_trans_0.5_spa", 17, 100, 0.002, 5, 0.5, -2, -2, 100, 100, 1001, 1, 0, 1, 4, 2, 1000, 0.3, 100, 1, 1);
