...
TEST_CASE("Ancestor hardware can attempt reproduction", "[lc]") {
  ...
  WHEN("logic tasks are used") {
    ...
    world.ProcessSymOutputBuffer(sgp_host); //(works depite lines?) I think this is this is the new function, but why doesn't it like the param
