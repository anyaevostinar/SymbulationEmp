...
/// SEG FAULT
// TEST_CASE("Host Task Credit", "[sgp][refactor1]") {
...
//   world.Setup();
//   world.Resize(2, 2);
//   //NEXT STEP: This test isn't working, run ./symbulation.test "[refactor1]" in terminal to debug
...
//       for (size_t task_id = 1; task_id < world.GetTaskEnv().GetTaskSet().GetSize(); task_id++) {
