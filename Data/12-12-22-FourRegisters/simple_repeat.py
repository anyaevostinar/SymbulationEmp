...
for a in seeds:
    for b in mois:
        ...
        command_str = './symbulation_parasite -SEED '+str(a)+ ' -START_MOI ' +str(b)+ ' -UPDATES 80000 -FILE_NAME _MOI'+str(b)
        settings_filename = "Output_MOI"+str(b)+"_LONG_SEED"+str(a)+".data"
