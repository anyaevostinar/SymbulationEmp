#Parameter names are: HRR, SLR, BS, BT, SL, POP, UPS, and T
#Abbreviations for HOST_REPRO_RES, SYM_LYSIS_RES, BURST_SIZE, BURST_TIME, SYM_LIMIT, POPULATION, UPDATES, and TRIALS
...
treatments = [
    [30, slr, 999999999, 1, 9999999990, 1600, updates, trial] \
         for slr in slrs[1:] for updates in [101,201,401,801] for trial in trials
]+[
    [30*bt, int(slr*bt) if int(round(slr*bt,14)) == round(slr*bt,14) else round(slr*bt,14), 999999999, bt, 999999999, 1600, 400*bt+1, trial] \
