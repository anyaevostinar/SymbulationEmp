...
1. In your local copy of the source code, update your main branch
...
2. Create a new branch and link it to your fork on GitHub:
...
4. Periodically update your branch from the Symbulation main
    branch:
...
5. Run the tests *before* pushing to GitHub:
...
7. Repeat until you're ready to merge your changes into "official"
    Symbulation.

8. Set up a Pull Request asking to merge things into the central
...
9. As you add new commits to address bugs or formatting issues, you can
    keep pushing your changes to the pull request by doing:

        git push origin

10. If we request changes, return to the step "Make some changes and
